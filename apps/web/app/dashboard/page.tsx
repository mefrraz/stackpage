                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {sites.map((site) => (
                        <div key={site.id} className="card p-5">
                            ...
                            <a
                                href={`https://stackpage-sites.vercel.app/${site.subdomain}`}
                                target="_blank"
                                className="text-sm text-muted-foreground mb-4 font-mono hover:underline block truncate"
                            >
                                stackpage-sites.vercel.app/{site.subdomain}
                            </a>
                            <div className="flex gap-2">
                                ...
                                <Button variant="outline" size="icon" className="h-9 w-9" onClick={() => window.open(`https://stackpage-sites.vercel.app/${site.subdomain}`, '_blank')}>
